...
export default {
  ...
  methods: {
    ...
    reply_loadTop: function() {
      let hostPath = "/api/MyWorkBill/GetMyWorkBillsRepliedRecord";
    ...
    accept() {
      ...
      setTimeout(function() {
        //指定路径指向
        let hostPath = "/api/MyWorkBill/GetWaitReplyBillsByDate";
    ...
    _import() {
      ...
      setTimeout(function() {
        //指定路径指向
        let hostPath = "/api/MyWorkBill/GetWaitReplyBillsByImport";
        _this.hostPath = hostPath;
        //调用数据请求封装方法
        _this.$myFun.loadTop(_this, "confirms", hostPath, "loadmore_wait");
        _this.isLoading = true;
    ...
    urge() {
      ...
      setTimeout(function() {
        //指定路径指向
        let hostPath = "/api/MyWorkBill/GetWaitReplyBillsByUrge";
        _this.hostPath = hostPath;
        //调用数据请求封装方法
        _this.$myFun.loadTop(_this, "confirms", hostPath, "loadmore_wait");
        _this.isLoading = true;
    ...
    timeRemaining() {
      ...
      setTimeout(function() {
        //指定路径指向
        let hostPath = "/api/MyWorkBill/GetWaitReplyBillsByTimeRemaining";
        _this.hostPath = hostPath;
        //调用数据请求封装方法
        _this.$myFun.loadTop(_this, "confirms", hostPath, "loadmore_wait");
        _this.isLoading = true;
